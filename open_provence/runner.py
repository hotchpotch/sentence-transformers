...
@dataclass
class OpenProvenceTrainingArguments(TrainingArguments):
...
def parse_config_file(config_file: str) -> Tuple[ModelArguments, DataArguments, OpenProvenceTrainingArguments]:
    ...
    training_args = OpenProvenceTrainingArguments(
...
def main():
    ...
    parser = HfArgumentParser((ModelArguments, DataArguments, OpenProvenceTrainingArguments))
