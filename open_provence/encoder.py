...
from .utils.sentence_transformers_compat import import_from_string, fullname, MultilingualChunker
from .data_structures import OpenProvenceConfig, RerankingOpenProvenceOutput, OpenProvenceOutput, OpenProvenceOnlyOutput
from .models.openprovence_head import OpenProvenceHead, OpenProvenceHeadConfig
...
class OpenProvenceEncoder(nn.Module):
    """
    OpenProvenceEncoder performs query-dependent text pruning with optional reranking.
    ...
    def __init__(
        ...
        self.pruning_config = OpenProvenceConfig()
    ...
    ) -> Union[List[float], np.ndarray, torch.Tensor, List[OpenProvenceOutput]]:
        """
    ...
    def predict_with_pruning(
        ...
        return_documents: bool = False,
        show_progress_bar: bool = False,
    ) -> Union[RerankingOpenProvenceOutput, OpenProvenceOnlyOutput, List[Union[RerankingOpenProvenceOutput, OpenProvenceOnlyOutput]]]:
        """
        ...
        Returns:
            RerankingOpenProvenceOutput/OpenProvenceOnlyOutput or list of them based on mode
        """
        self.eval()
    ...
    def predict_context(
        ...
        show_progress_bar: bool = False,
    ) -> Union[OpenProvenceOutput, List[OpenProvenceOutput]]:
        """
    ...
    def save_pretrained(self, save_directory: Union[str, Path]) -> None:
        ...
        # Save OpenProvenceEncoder-specific config
        pruning_encoder_config = {
            ...
            "architecture": "OpenProvenceEncoder",
        ...
        transformers_config = {
            ...
            "architectures": [
                "OpenProvenceEncoderForSequenceClassification" if self.mode == "reranking_pruning" 
                else "OpenProvenceEncoderForTokenClassification"
            ],
            "auto_map": {
                "AutoConfig": "modeling_openprovence_encoder.OpenProvenceEncoderConfig",
                "AutoModelForSequenceClassification": "modeling_openprovence_encoder.OpenProvenceEncoderForSequenceClassification" if self.mode == "reranking_pruning" else None,
                "AutoModelForTokenClassification": "modeling_openprovence_encoder.OpenProvenceEncoderForTokenClassification" if self.mode == "pruning_only" else None,
            }
        }
    ...
    def from_pretrained(
        ...
        **kwargs
        ...
        # Load config - try OpenProvenceEncoder config first, then Transformers config
        ...
        # Load pruning head
        encoder.pruning_head = OpenProvenceHead.from_pretrained(
    ...
    def export_ranking_model(self, save_directory: Union[str, Path]) -> None:
    ...
    def to(self, device: Union[str, torch.device]) -> "OpenProvenceEncoder":
