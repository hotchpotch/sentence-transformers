#!/usr/bin/env python3
"""
Process full 1.3M dataset with proper batching for all 5 texts per query.
Full scale dataset processing.
"""
...
def main():
    logger.info("Processing full 1.3M dataset with batched approach...")
    ...
    # Process each split
    processed_splits = {}
    batch_size = 32  # Smaller batch size for memory efficiency with full dataset
    ...
    for split_name, split_data in dataset.items():
        ...
        # Check pruning label distribution on sample
        all_labels = []
        all_ranking_labels = []
