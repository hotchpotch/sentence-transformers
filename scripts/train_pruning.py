#!/usr/bin/env python3
"""
統合されたPruningモデル学習スクリプト
Usage: python train_pruning.py --target {minimal|small|full}
"""
...
def main():
    parser = argparse.ArgumentParser(description='Train Pruning model')
    parser.add_argument(
        '--target', 
        type=str, 
        required=True,
    ...
    if args.output_dir is None:
        args.output_dir = f'outputs/pruning-ja-{args.target}'
    ...
    print(f"=== Pruning {args.target.upper()} Training ===")
