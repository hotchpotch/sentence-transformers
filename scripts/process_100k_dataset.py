#!/usr/bin/env python3
"""
Fast processing of 100k dataset with batched teacher scores.
"""
...
def main():
    logger.info("Fast processing of 100k dataset...")
    
    # Paths
    input_path = "tmp/datasets/dev-dataset/small-100k"
    output_path = "tmp/datasets/dev-dataset/small-100k-processed"
