#!/usr/bin/env python
"""
Train pruning-only model on full msmarco-small-ja dataset.
"""
...
def main():
    """Train pruning-only model on full msmarco-small-ja."""
    logger.info("="*60)
    logger.info("Training Full Pruning-Only Model (MS MARCO Small-JA)")
    logger.info("="*60)
    
    # Output directory
    timestamp = datetime.now().strftime('%Y%m%d_%H%M%S')
    output_dir = f"./output/msmarco_small_ja_full_pruning_only_{timestamp}"
