#!/usr/bin/env python3
"""
統合されたProvenceモデル評価スクリプト
Usage: python evaluate_provence.py --model_path path/to/model --target {minimal|small|full}
"""
...
def main():
    parser = argparse.ArgumentParser(description='Evaluate Provence model')
    parser.add_argument(
        '--model_path',
        type=str,
        required=True,
    ...
    # モデルの読み込み
    print("モデル読み込み中...")
    model = ProvenceEncoder.from_pretrained(args.model_path)
    model.eval()
