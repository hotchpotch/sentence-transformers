"""
ProvenceTrainer: Trainer for ProvenceEncoder models.
"""
...
class ProvenceTrainer:
    """
    Trainer for ProvenceEncoder models.
    ...
    def train(self):
        ...
        if self.best_model_path is not None:
            ...
            self.model = ProvenceEncoder.from_pretrained(self.best_model_path)
