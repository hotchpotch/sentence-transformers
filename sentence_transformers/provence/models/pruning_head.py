"""
Provence Pruning Head module for token classification.
...
class ProvencePruningConfig(PretrainedConfig):
    """Configuration class for ProvencePruningHead."""
...
class ProvencePruningHead(PreTrainedModel):
    """
    Pruning head for Provence that can be used standalone or integrated with CrossEncoder.
    Compatible with AutoModelForTokenClassification.
    """
    
    config_class = ProvencePruningConfig
    
    def __init__(self, config: ProvencePruningConfig):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: str, **kwargs):
        ...
        # Load config
        config = ProvencePruningConfig.from_pretrained(pretrained_model_name_or_path, **kwargs)
