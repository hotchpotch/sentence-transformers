"""
ProvenceChunkBasedLoss for chunk-based data collator outputs.
"""
...
class ProvenceChunkBasedLoss(nn.Module):
    """
    Loss function designed for ProvenceChunkBasedDataCollator outputs.
