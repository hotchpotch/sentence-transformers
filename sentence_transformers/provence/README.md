# Provence: Query-Dependent Text Pruning

Provence is a module for efficient query-dependent text pruning in RAG (Retrieval-Augmented Generation) pipelines. It combines reranking and pruning capabilities to:
...
Provence is included in the sentence-transformers library. No additional installation required.
...
encoder = ProvenceEncoder.from_pretrained("path/to/provence/model")
...
- `loss_fn`: Loss function (optional, uses ProvenceLoss by default)
