"""
Data structures for Provence (Query-dependent Text Pruning) support in CrossEncoder.
"""
...
class ProvenceOutput:
    """
    Output dataclass for Provence predictions containing both reranking and pruning results.
    ...
    def __repr__(self) -> str:
        ...
        return f"ProvenceOutput({', '.join(parts)})"


@dataclass 
class ProvenceConfig:
    """Configuration for Provence functionality."""
