...
URL Source: http://huggingface.co/blog/train-sparse-encoder
...
[](http://huggingface.co/blog/train-sparse-encoder#table-of-contents) Table of Contents
---------------------------------------------------------------------------------------

*   [What are Sparse Embedding models?](http://huggingface.co/blog/train-sparse-encoder#what-are-sparse-embedding-models)
    *   [Query and Document Expansion](http://huggingface.co/blog/train-sparse-encoder#query-and-document-expansion)
    *   [Why Use Sparse Embedding Models?](http://huggingface.co/blog/train-sparse-encoder#why-use-sparse-embedding-models)

*   [Why Finetune?](http://huggingface.co/blog/train-sparse-encoder#why-finetune)
*   [Training Components](http://huggingface.co/blog/train-sparse-encoder#training-components)
*   [Model](http://huggingface.co/blog/train-sparse-encoder#model)
    *   [Splade](http://huggingface.co/blog/train-sparse-encoder#splade)
    *   [Inference-free Splade](http://huggingface.co/blog/train-sparse-encoder#inference-free-splade)
    *   [Contrastive Sparse Representation (CSR)](http://huggingface.co/blog/train-sparse-encoder#contrastive-sparse-representation-csr)
    *   [Architecture Picker Guide](http://huggingface.co/blog/train-sparse-encoder#architecture-picker-guide)

*   [Dataset](http://huggingface.co/blog/train-sparse-encoder#dataset)
    *   [Data on the Hugging Face Hub](http://huggingface.co/blog/train-sparse-encoder#data-on-the-hugging-face-hub)
    *   [Local Data (CSV, JSON, Parquet, Arrow, SQL)](http://huggingface.co/blog/train-sparse-encoder#local-data-csv-json-parquet-arrow-sql)
    *   [Local Data that requires pre-processing](http://huggingface.co/blog/train-sparse-encoder#local-data-that-requires-pre-processing)
    *   [Dataset Format](http://huggingface.co/blog/train-sparse-encoder#dataset-format)

*   [Loss Function](http://huggingface.co/blog/train-sparse-encoder#loss-function)
*   [Training Arguments](http://huggingface.co/blog/train-sparse-encoder#training-arguments)
*   [Evaluator](http://huggingface.co/blog/train-sparse-encoder#evaluator)
    *   [SparseNanoBEIREvaluator](http://huggingface.co/blog/train-sparse-encoder#sparsenanobeirevaluator)
    *   [SparseEmbeddingSimilarityEvaluator with STSb](http://huggingface.co/blog/train-sparse-encoder#sparseembeddingsimilarityevaluator-with-stsb)
    *   [SparseTripletEvaluator with AllNLI](http://huggingface.co/blog/train-sparse-encoder#sparsetripletevaluator-with-allnli)

*   [Trainer](http://huggingface.co/blog/train-sparse-encoder#trainer)
    *   [Callbacks](http://huggingface.co/blog/train-sparse-encoder#callbacks)
    *   [Multi-Dataset Training](http://huggingface.co/blog/train-sparse-encoder#multi-dataset-training)

*   [Evaluation](http://huggingface.co/blog/train-sparse-encoder#evaluation)
*   [Training Tips](http://huggingface.co/blog/train-sparse-encoder#training-tips)
*   [Vector Database Integration](http://huggingface.co/blog/train-sparse-encoder#vector-database-integration)
*   [Additional Resources](http://huggingface.co/blog/train-sparse-encoder#additional-resources)
    *   [Training Examples](http://huggingface.co/blog/train-sparse-encoder#training-examples)
    *   [Documentation](http://huggingface.co/blog/train-sparse-encoder#documentation)

[](http://huggingface.co/blog/train-sparse-encoder#what-are-sparse-embedding-models) What are Sparse Embedding models?
----------------------------------------------------------------------------------------------------------------------
...
### [](http://huggingface.co/blog/train-sparse-encoder#query-and-document-expansion) Query and Document Expansion
...
### [](http://huggingface.co/blog/train-sparse-encoder#why-use-sparse-embedding-models) Why Use Sparse Embedding Models?
...
[](http://huggingface.co/blog/train-sparse-encoder#why-finetune) Why Finetune?
------------------------------------------------------------------------------
...
[](http://huggingface.co/blog/train-sparse-encoder#training-components) Training Components
-------------------------------------------------------------------------------------------

Training Sentence Transformer models involves the following components:

1.   [**Model**](http://huggingface.co/blog/train-sparse-encoder#model): The model to train or finetune, which can be a pre-trained Sparse Encoder model or a base model.
2.   [**Dataset**](http://huggingface.co/blog/train-sparse-encoder#dataset): The data used for training and evaluation.
3.   [**Loss Function**](http://huggingface.co/blog/train-sparse-encoder#loss-function): A function that quantifies the model's performance and guides the optimization process.
4.   [**Training Arguments**](http://huggingface.co/blog/train-sparse-encoder#training-arguments) (optional): Parameters that influence training performance and tracking/debugging.
5.   [**Evaluator**](http://huggingface.co/blog/train-sparse-encoder#evaluator) (optional): A tool for evaluating the model before, during, or after training.
6.   [**Trainer**](http://huggingface.co/blog/train-sparse-encoder#trainer): Brings together the model, dataset, loss function, and other components for training.

Now, let's dive into each of these components in more detail.

[](http://huggingface.co/blog/train-sparse-encoder#model) Model
---------------------------------------------------------------
...
### [](http://huggingface.co/blog/train-sparse-encoder#splade) Splade
...
### [](http://huggingface.co/blog/train-sparse-encoder#inference-free-splade) Inference-free Splade
...
### [](http://huggingface.co/blog/train-sparse-encoder#contrastive-sparse-representation-csr) Contrastive Sparse Representation (CSR)
...
### [](http://huggingface.co/blog/train-sparse-encoder#architecture-picker-guide) Architecture Picker Guide

If you're unsure which architecture to use, here's a quick guide:

*   Do you want to sparsify an existing Dense Embedding model? If yes, use [**CSR**](http://huggingface.co/blog/train-sparse-encoder#contrastive-sparse-representation-csr).
*   Do you want your query inference to be instantaneous at the cost of slight performance? If yes, use [**Inference-free SPLADE**](http://huggingface.co/blog/train-sparse-encoder#inference-free-splade).
*   Otherwise, use [**SPLADE**](http://huggingface.co/blog/train-sparse-encoder#splade).

[](http://huggingface.co/blog/train-sparse-encoder#dataset) Dataset
-------------------------------------------------------------------
...
### [](http://huggingface.co/blog/train-sparse-encoder#data-on-the-hugging-face-hub) Data on the Hugging Face Hub
...
### [](http://huggingface.co/blog/train-sparse-encoder#local-data-csv-json-parquet-arrow-sql) Local Data (CSV, JSON, Parquet, Arrow, SQL)
...
### [](http://huggingface.co/blog/train-sparse-encoder#local-data-that-requires-pre-processing) Local Data that requires pre-processing
...
### [](http://huggingface.co/blog/train-sparse-encoder#dataset-format) Dataset Format

It's crucial to ensure that your dataset format matches your chosen [loss function](http://huggingface.co/blog/train-sparse-encoder#loss-function). This involves checking two things:
...
[](http://huggingface.co/blog/train-sparse-encoder#loss-function) Loss Function
-------------------------------------------------------------------------------
...
[](http://huggingface.co/blog/train-sparse-encoder#training-arguments) Training Arguments
-----------------------------------------------------------------------------------------
...
[](http://huggingface.co/blog/train-sparse-encoder#evaluator) Evaluator
-----------------------------------------------------------------------
...
### [](http://huggingface.co/blog/train-sparse-encoder#sparsenanobeirevaluator) SparseNanoBEIREvaluator
...
### [](http://huggingface.co/blog/train-sparse-encoder#sparseembeddingsimilarityevaluator-with-stsb) SparseEmbeddingSimilarityEvaluator with STSb
...
### [](http://huggingface.co/blog/train-sparse-encoder#sparsetripletevaluator-with-allnli) SparseTripletEvaluator with AllNLI
...
[](http://huggingface.co/blog/train-sparse-encoder#trainer) Trainer
-------------------------------------------------------------------
...
### [](http://huggingface.co/blog/train-sparse-encoder#callbacks) Callbacks
...
### [](http://huggingface.co/blog/train-sparse-encoder#multi-dataset-training) Multi-Dataset Training
...
[](http://huggingface.co/blog/train-sparse-encoder#evaluation) Evaluation
-------------------------------------------------------------------------
...
[](http://huggingface.co/blog/train-sparse-encoder#training-tips) Training Tips
-------------------------------------------------------------------------------
...
[](http://huggingface.co/blog/train-sparse-encoder#vector-database-integration) Vector Database Integration
-----------------------------------------------------------------------------------------------------------
...
### [](http://huggingface.co/blog/train-sparse-encoder#qdrant-integration-example) Qdrant Integration Example
...
### [](http://huggingface.co/blog/train-sparse-encoder#prerequisites) Prerequisites:
...
[](http://huggingface.co/blog/train-sparse-encoder#additional-resources) Additional Resources
---------------------------------------------------------------------------------------------

### [](http://huggingface.co/blog/train-sparse-encoder#training-examples) Training Examples
...
### [](http://huggingface.co/blog/train-sparse-encoder#documentation) Documentation
