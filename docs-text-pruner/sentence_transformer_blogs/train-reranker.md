...
URL Source: http://huggingface.co/blog/train-reranker
...
[](http://huggingface.co/blog/train-reranker#table-of-contents) Table of Contents
---------------------------------------------------------------------------------

*   [What are Reranker models?](http://huggingface.co/blog/train-reranker#what-are-reranker-models)
*   [Why Finetune?](http://huggingface.co/blog/train-reranker#why-finetune)
*   [Training Components](http://huggingface.co/blog/train-reranker#training-components)
*   [Dataset](http://huggingface.co/blog/train-reranker#dataset)
    *   [Data on the Hugging Face Hub](http://huggingface.co/blog/train-reranker#data-on-the-hugging-face-hub)
    *   [Local Data (CSV, JSON, Parquet, Arrow, SQL)](http://huggingface.co/blog/train-reranker#local-data-csv-json-parquet-arrow-sql)
    *   [Local Data that requires pre-processing](http://huggingface.co/blog/train-reranker#local-data-that-requires-pre-processing)
    *   [Dataset Format](http://huggingface.co/blog/train-reranker#dataset-format)
    *   [Hard Negatives Mining](http://huggingface.co/blog/train-reranker#hard-negatives-mining)

*   [Loss Function](http://huggingface.co/blog/train-reranker#loss-function)
*   [Training Arguments](http://huggingface.co/blog/train-reranker#training-arguments)
*   [Evaluator](http://huggingface.co/blog/train-reranker#evaluator)
    *   [CrossEncoderCorrelationEvaluator with STSb](http://huggingface.co/blog/train-reranker#crossencodercorrelationevaluator-with-stsb)
    *   [CrossEncoderRerankingEvaluator with GooAQ mined negatives](http://huggingface.co/blog/train-reranker#crossencoderrerankingevaluator-with-gooaq-mined-negatives)

*   [Trainer](http://huggingface.co/blog/train-reranker#trainer)
    *   [Callbacks](http://huggingface.co/blog/train-reranker#callbacks)
    *   [Multi-Dataset Training](http://huggingface.co/blog/train-reranker#multi-dataset-training)

*   [Training Tips](http://huggingface.co/blog/train-reranker#training-tips)
*   [Evaluation](http://huggingface.co/blog/train-reranker#evaluation)
*   [Additional Resources](http://huggingface.co/blog/train-reranker#additional-resources)
    *   [Training Examples](http://huggingface.co/blog/train-reranker#training-examples)
    *   [Documentation](http://huggingface.co/blog/train-reranker#documentation)

[](http://huggingface.co/blog/train-reranker#what-are-reranker-models) What are Reranker models?
------------------------------------------------------------------------------------------------
...
[](http://huggingface.co/blog/train-reranker#why-finetune) Why Finetune?
------------------------------------------------------------------------
...
In the [Evaluation](http://huggingface.co/blog/train-reranker#evaluation) section end of this blogpost, I'll show that training a model on your domain can outperform any general-purpose reranker model, even if those baselines are much bigger. Don't underestimate the power of finetuning on your domain!

[](http://huggingface.co/blog/train-reranker#training-components) Training Components
-------------------------------------------------------------------------------------

Training reranker models involves the following components:

1.   [**Dataset**](http://huggingface.co/blog/train-reranker#dataset): The data used for training and/or evaluation.
2.   [**Loss Function**](http://huggingface.co/blog/train-reranker#loss-function): A function that measures the model's performance and guides the optimization process.
3.   [**Training Arguments**](http://huggingface.co/blog/train-reranker#training-arguments) (optional): Parameters that impact training performance, tracking, and debugging.
4.   [**Evaluator**](http://huggingface.co/blog/train-reranker#evaluator) (optional): A class for evaluating the model before, during, or after training.
5.   [**Trainer**](http://huggingface.co/blog/train-reranker#trainer): Brings together all training components.

Let's take a closer look at each component.

[](http://huggingface.co/blog/train-reranker#dataset) Dataset
-------------------------------------------------------------
...
### [](http://huggingface.co/blog/train-reranker#data-on-the-hugging-face-hub) Data on the Hugging Face Hub
...
### [](http://huggingface.co/blog/train-reranker#local-data-csv-json-parquet-arrow-sql) Local Data (CSV, JSON, Parquet, Arrow, SQL)
...
### [](http://huggingface.co/blog/train-reranker#local-data-that-requires-pre-processing) Local Data that requires pre-processing
...
### [](http://huggingface.co/blog/train-reranker#dataset-format) Dataset Format
...
### [](http://huggingface.co/blog/train-reranker#hard-negatives-mining) Hard Negatives Mining
...
[](http://huggingface.co/blog/train-reranker#loss-function) Loss Function
-------------------------------------------------------------------------
...
[](http://huggingface.co/blog/train-reranker#training-arguments) Training Arguments
-----------------------------------------------------------------------------------
...
### [](http://huggingface.co/blog/train-reranker#crossencodercorrelationevaluator-with-stsb) CrossEncoderCorrelationEvaluator with STSb
...
### [](http://huggingface.co/blog/train-reranker#crossencoderrerankingevaluator-with-gooaq-mined-negatives) CrossEncoderRerankingEvaluator with GooAQ mined negatives
...
[](http://huggingface.co/blog/train-reranker#trainer) Trainer
-------------------------------------------------------------
...
After running this script, the [tomaarsen/reranker-ModernBERT-base-gooaq-bce](https://huggingface.co/tomaarsen/reranker-ModernBERT-base-gooaq-bce) model was uploaded for me. See the upcoming [Evaluation](http://huggingface.co/blog/train-reranker#evaluation) section with evidence that this model outperformed 13 commonly used open-source alternatives, including much bigger models. I also ran the model with [`answerdotai/ModernBERT-large`](https://huggingface.co/answerdotai/ModernBERT-large) as the base model, resulting in [tomaarsen/reranker-ModernBERT-large-gooaq-bce](https://huggingface.co/tomaarsen/reranker-ModernBERT-large-gooaq-bce).
...
### [](http://huggingface.co/blog/train-reranker#callbacks) Callbacks
...
### [](http://huggingface.co/blog/train-reranker#multi-dataset-training) Multi-Dataset Training
...
[](http://huggingface.co/blog/train-reranker#training-tips) Training Tips
-------------------------------------------------------------------------
...
[](http://huggingface.co/blog/train-reranker#additional-resources) Additional Resources
---------------------------------------------------------------------------------------

### [](http://huggingface.co/blog/train-reranker#training-examples) Training Examples
...
### [](http://huggingface.co/blog/train-reranker#documentation) Documentation
